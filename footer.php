...
<body>
                ...
                <div class="row footer-content">
                    <div class="copyright col-md-6">
                        <?php if (ot_get_option('copyright')) {
                            ...
                            echo __('WordPress Theme by (C) CactusThemes', 'cactusthemes');
                        } ?>
                    </div>
    ...
    <div class="mobile-menu-wrap dark-div visible-xs">
        <div class="container">
            <form id="mobile-search" action="<?php echo home_url() ?>">
                <input type="search" name="s" class="form-control search-field" placeholder="<?php _e('Search Here', 'cactusthemes') ?>" autocomplete="off">
            </form>
        </div>
